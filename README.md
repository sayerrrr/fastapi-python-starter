...
- 🎯 Entry points to execute your program using `python -m <fastapi_python_starter>` or `$ fastapi_python_starter` with basic CLI argument parsing.
...
---
# fastapi_python_starter

[![codecov](https://codecov.io/gh/sayerrrr/fastapi-python-starter/branch/main/graph/badge.svg?token=fastapi-python-starter_token_here)](https://codecov.io/gh/sayerrrr/fastapi-python-starter)
[![CI](https://github.com/sayerrrr/fastapi-python-starter/actions/workflows/main.yml/badge.svg)](https://github.com/sayerrrr/fastapi-python-starter/actions/workflows/main.yml)

Awesome fastapi_python_starter created by sayerrrr

## Install

from source
```bash
git clone https://github.com/sayerrrr/fastapi-python-starter fastapi_python_starter
cd fastapi_python_starter
make install
```
...
```bash
pip install fastapi_python_starter
```

## Executing

```bash
$ fastapi_python_starter run --port 8080
```

or

```bash
python -m fastapi_python_starter run --port 8080
```

or

```bash
$ uvicorn fastapi_python_starter:app
```

## CLI

```bash
❯ fastapi_python_starter --help
Usage: fastapi_python_starter [OPTIONS] COMMAND [ARGS]...
...
```bash
❯ fastapi_python_starter create-user --help
Usage: fastapi_python_starter create-user [OPTIONS] USERNAME PASSWORD
...
```bash
fastapi_python_starter create-user admin admin --superuser
```
...
Run with `fastapi_python_starter run` and access http://127.0.0.1:8000/docs

![](https://raw.githubusercontent.com/rochacbruno/fastapi-project-template/master/docs/api.png)


**For some api calls you must authenticate** using the user created with `fastapi_python_starter create-user`.
...
-----------------------------------------------------
fastapi_python_starter/__init__.py              4      0   100%
fastapi_python_starter/app.py                  16      1    94%
fastapi_python_starter/cli.py                  21      0   100%
fastapi_python_starter/config.py                5      0   100%
fastapi_python_starter/db.py                   10      0   100%
fastapi_python_starter/models/__init__.py       0      0   100%
fastapi_python_starter/models/content.py       47      1    98%
fastapi_python_starter/routes/__init__.py      11      0   100%
fastapi_python_starter/routes/content.py       52     25    52%
fastapi_python_starter/routes/security.py      15      1    93%
fastapi_python_starter/routes/user.py          52     26    50%
fastapi_python_starter/security.py            103     12    88%
-----------------------------------------------------
TOTAL                               336     66    80%
...
> `dynaconf_merge` is a boolean that tells if the settings should be merged with the default settings defined in fastapi_python_starter/default.toml.
