...
description = """
fastapi_python_starter API helps you do awesome stuff. 🚀
"""

app = FastAPI(
    title="fastapi_python_starter",
    description=description,
    version=read("VERSION"),
    terms_of_service="http://fastapi_python_starter.com/terms/",
    contact={
        "name": "sayerrrr",
        "url": "http://fastapi_python_starter.com/contact/",
        "email": "sayerrrr@fastapi_python_starter.com",
    },
    license_info={
        "name": "The Unlicense",
