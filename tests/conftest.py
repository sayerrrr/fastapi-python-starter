...
# WARNING: Ensure imports from `fastapi_python_starter` comes after this line
from fastapi_python_starter import app, settings, db  # noqa
from fastapi_python_starter.cli import create_user, cli  # noqa
